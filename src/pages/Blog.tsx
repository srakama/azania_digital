...
export async function generateWithCustomModel(prompt: string) {
  ...
  return (
    <div style={{ paddingTop: '80px' }}>
      ...
      {/* Blog Posts Grid */}
      <section id="blog-posts" className="section" style={{
      ...
      <section id="newsletter" className="section" style={{
        ...
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '600px', margin: '0 auto' }}>
            ...
            {/* Hidden iframe for newsletter form submission */}
            <iframe
              name="newsletter_iframe"
              style={{ display: 'none' }}
              onLoad={() => {
                console.log('Newsletter form submitted successfully via iframe');
              }}
            />
          </div>
        </div>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-3">
            <div className="card">
              ...
              <button
                onClick={() => handleAction('web-dev-guide')}
            ...
            <div className="card">
              ...
              <button
                onClick={() => handleAction('seo-checklist')}
                className="btn btn-primary"
                style={{
            ...
            <div className="card">
              ...
              <button
                onClick={() => handleAction('design-templates')}
                className="btn btn-primary"
                style={{
