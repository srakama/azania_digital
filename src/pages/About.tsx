        ...
        <div className="container" style={{ position: 'relative', zIndex: '2' }}>
          <div style={{ textAlign: 'center', maxWidth: '900px', margin: '0 auto' }}>
            ...
            <p style={{
              ...
              We are a <span style={{ color: '#34D399', fontWeight: '600' }}>South African digital agency</span> specializing in
              <span style={{ color: '#38BDF8', fontWeight: '600' }}> cutting-edge web development</span>. Our mission is to empower
              businesses with <span style={{ color: '#A78BFA', fontWeight: '600' }}>innovative technology</span> that drives measurable growth.
            </p>
            ...
            <div style={{
              ...
              {[
                { number: '2019', label: 'Founded', color: '#34D399' },
                { number: '50+', label: 'Projects', color: '#38BDF8' },
                { number: '100%', label: 'Client Satisfaction', color: '#A78BFA' },
